...
<html>
 ...
 <%SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");//可以方便地修改日期格式
  ...
  <body>
  <p class="R-Tit" align="center">各科室单位柱状统计图</p>
  ...
  <form id="form119" action="jfreechart/department!searchListbykeshi.action" method="post" style="display:none;">
  <table  width="100%">
  		<tr><td colspan="2">
 		...
 		<input type="radio" name="condition" value="3" onclick="check(this)"/>月</td></tr>		
  		...
  		<td width="30%"><input type="submit" value="搜索" class="btn"/>
...
JFreeChart chart = ChartFactory.createBarChart3D("", "", "问题次数",dataset, PlotOrientation.HORIZONTAL, true, false, false);
...
String filename = ServletUtilities.saveChartAsPNG(chart,900,1400, null, session); 
String graphURL = request.getContextPath() + "/displaychart?filename=" + filename; 
%>

<img src="<%= graphURL %>" width=900 height=1400 border=0
	usemap="#<%= filename %>">
	  </div>
  </body>
</html>