...
<html>
  ...
  <body>
    <form action="${ctx }/manage/complaint/webInspect!listprint.action" method="post" target="_new">
  ...
  <tr>
    ...
    <td nowrap><c:if test="${com.leaderapproved==1 }"><img src="${ctx}/images/not1.png" title="无法修改"></c:if>
    			...
    			<a href="${ctx }/manage/complaint/webInspect!edit.action?complaintid=${com.complaintid}"><img src="${ctx}/images/edit.gif" title="编辑"></a></c:if>|&nbsp;
    			
    			<c:if test="${com.leaderapproved==1 }"><img src="${ctx}/images/not.png" title="无法删除"></c:if>
    			<c:if test="${com.leaderapproved!=1}">
    			<a href="${ctx }/manage/complaint/webInspect!delete.action?complaintid=${com.complaintid}" onclick="return confirm('确实要删除吗?')">
    			<img src="${ctx}/images/delete.gif" title="删除"></a></c:if>&nbsp;|
    			
    			<a href="${ctx }/manage/complaint/webInspect!show.action?complaintid=${com.complaintid}"><img src="${ctx }/images/find.png" title="详情"></a></td>
  </tr>
  </c:forEach>
