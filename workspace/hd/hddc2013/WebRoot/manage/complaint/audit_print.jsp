...
<br><p class="R-Tit" align="center">审核表</p>
  ...
  <tr>
    ...
    <th align="center" nowrap width="22%">问题分类</th>
     <th align="center" nowrap width="6%">预警</th>
    <th align="center" nowrap width="5%">扣分</th>
    <th align="center" nowrap width="8%">审核</th>
  ...
  <tr>
    ...
    <td align="center" valign="top"><c:forEach items="${com.departments }" var="dep" varStatus="j">
