...
<html>
  ...
  <body>
   <div class="R-CON" align="center">
  	  <p class="R-Tit" align="center" style="{width:70% }">数据库还原</p>
          <form id="form1" action="manage/system/mysql!sqlLoad.action" method="post">
             <table width="1000px" border="0" style="top: 51px; height: 149px;">
              ...
              <tr>
                <td align="center">请选择路径：</td>
                <td><input type="file" name="filePath" autocomplete="off"/></td>               
              </tr> 
             <div align="center"><strong><font size="3"><span><font color="red">${error2 }</font></span></font></strong></div>
              <tr>
