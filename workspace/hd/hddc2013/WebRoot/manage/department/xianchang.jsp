...
history.go(-1); //后退1页  
  ...
  <body><br><br>
<form action="${ctx }/manage/department/xianchang_print.jsp" method="post" target="_new">
  ...
  <span align="center"><font size="5">现场督察</font></span> 
<span style="{position:absolute;top:8%;right:6%;}"><font size="3">总数：${list3.size() }</font></span>
  <table style="width:92%;" border="1" cellspacing="0" cellpadding="0" align="center">   
    ...
    <tr>
      <c:forEach items="${list3}" var="complaint" varStatus="i" >
       	<tr>
       	<td><a href="${ctx }/manage/complaint/fieldInspect!show.action?complaintid=${complaint.complaintid}">${complaint.sno }</a></</td>
