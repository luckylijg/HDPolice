...
history.go(-1); //后退1页  
  ...
  <body><br><br>
<form action="${ctx }/manage/department/wangluo_print.jsp" method="post" target="_new">
 ...
 <div style="{position:absolute;top:7%;left:4%;}">
  ...
  <span align="center"><font size="5">网络舆情</font></span> 
<span style="{position:absolute;top:8%;right:6%;}"><font size="3">总数：${list5.size() }</font></span>
  <table style="width:92%;" border="1" cellspacing="0" cellpadding="0" align="center">   
    ...
    <tr>
      <c:forEach items="${list5}" var="complaint" varStatus="i" >
       	<tr>
       	<td><a href="${ctx }/manage/complaint/popularFeelings!show.action?complaintid=${complaint.complaintid}">${complaint.sno }</a></td>
