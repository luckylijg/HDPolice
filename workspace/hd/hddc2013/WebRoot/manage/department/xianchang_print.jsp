...
<div style="{position:absolute;right:6%;}"><font size="3">总数：${sessionScope.xianchang_list.size() }</font></div>
  ...
  <table style="width:91%;" border="1" cellspacing="0" cellpadding="0" align="center">   
    ...
    <c:forEach items="${sessionScope.xianchang_list}" var="complaint" varStatus="i" >
