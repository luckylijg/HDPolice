...
<br>
<div align="center"> 
  <span align="center"><font size="5"><c:if test="${year==0 }">各大队排名统计表 </c:if >
  ...
  <form id="fromId" action="${ctx }/manage/department/department!printpaimingdadui.action" target="_new">
  ...
  <input type="hidden" name="month" value=${param.month }>
   <input type="image" onclick="javascript:document.getElementById('fromId').submit();" src="${ctx }/images/print.png"/>  
      ...
      <div class="R-CON">
       <form id="form119" action="manage/department/department!paimingdadui.action" method="post" style="display:none;">
