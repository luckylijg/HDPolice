...
<table id="PrintControl" width="100%" border="0" cellspacing="0" cellpadding="0" class="Noprint">
  ...
  <span align="center"><font size="5">网络督察</font></span> 
<div style="{position:absolute;right:6%;}"><font size="3">总数：${sessionScope.wangluo_list.size() }</font></div>
 <br> <table style="width:91%;" border="1" cellspacing="0" cellpadding="0" align="center">   
    <tr>
      <th style="width:7%">编号</th>
      <th style="width:12%">时间</th>
      <th style="width:36%">涉及人员</th>
      <th style="width:39%">问题类别</th>
      <th style="width:6%">扣分</th>
    </tr>
    <c:forEach items="${sessionScope.wangluo_list}" var="complaint" varStatus="i" >
