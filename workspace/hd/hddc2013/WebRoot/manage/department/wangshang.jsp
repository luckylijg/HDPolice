...
<form action="${ctx }/manage/department/wangshang_print.jsp" method="post" target="_new">
...
<span style="{position:absolute;top:8%;right:6%;}"><font size="3">总数：${list4.size() }</font></span>
  <table style="width:92%;" border="1" cellspacing="0" cellpadding="0" align="center">   
    ...
    <tr>
      <c:forEach items="${list4}" var="complaint" varStatus="i" >
       	<tr>
       	<td><a href="${ctx }/manage/complaint/webInspect!show.action?complaintid=${complaint.complaintid}">${complaint.sno }</a></td>
