...
public class EntityDaoImpl<T,PK extends Serializable> extends HibernateDaoSupport implements EntityDao<T,PK> {
	...
	　　* @return 记录List集 
	　　*/ 
	public List<T> findAll(Class<T> entityClass, String propertyName,
	...
	public List<T> findByCriteria(final Class<T> entityClass,final String propertyName,
			final boolean isAsc,final int firstResult,final int maxResults,final Criterion... criterions) {
	...
	　　*/ 
	public Pager<T> findForPager(Class<T> entityClass, String propertyName,
			boolean isAsc, int firstResult, int maxResults, Criterion... criterions) {
	...
	　　*/ 
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Pager<T> findForPagerByHql(final int firstResult, final int maxResults, final String hql,
			final Object[] params) {
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public T findUniqueByProperty(final Class<T> entityClass,final String propertyName,
			final Object value) {
		T t = (T)getHibernateTemplate().execute(new HibernateCallback(){ 
			public Object doInHibernate(Session session) 
			throws HibernateException, SQLException { 
	...
	　　*/ 
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public boolean isPropertyExist(final Class<T> entityClass,final String propertyName,
			final Object value) {
